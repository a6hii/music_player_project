...
class _PlayListScreenState extends State<PlayListScreen> {
  ...
  Widget build(BuildContext context) {
    final check =
        PlayListFunctions.ids[widget.index].contains(MainPage.selectedid);
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      //*playlist title
                      Text(
                        widget.playlistname.length < 10
                            ? widget.playlistname
                            : '${widget.playlistname.substring(0, 10)}...',
                        style: TextStyle(
                            color: Themecolors.fontColor ?? Colors.white,
                            fontSize: 30,
                          ...
                          onTap: () {
                            ...
                            Navigator.of(context)
                                .push(MaterialPageRoute(
                                    builder: (context) => AddSongFromPlayList(
                                          index: widget.index,
                                        )))
                                .whenComplete(() {
                              setState(() {});
                  ...
                  child: ClipRRect(
                    ...
                    child: ValueListenableBuilder(
                      ...
                      builder: (BuildContext context,
                          List<dynamic> playlistsongs, Widget? child) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                                onTap: () {
                                  if (Musics
                                          .songslist[playlistsongs[index]].id ==
                                      MainPage.selectedid) {
