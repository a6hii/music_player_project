...
class ProgressBarscreen extends StatelessWidget {
  const ProgressBarscreen(
      {Key? key, this.barHeight, this.fontsize, this.thumbRadius})
      : super(key: key);
        ...
        StreamBuilder<DurationState>(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            ...
            return ProgressBar(
                ...
                baseBarColor: Themecolors.progress ??
                    const Color.fromARGB(73, 255, 255, 255),
                progressBarColor: Themecolors.fontColor ?? Colors.white,
                thumbColor: Themecolors.fontColor ?? Colors.white,
